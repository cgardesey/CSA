...
namespace TMSA
{
    public partial class frmFSrecordsImport : Form
    {
        SqlConnection con;
        SqlCommand cmd;
        SqlDataReader dr;
        ...
        {
            Singleton.fsrecordsimport = null;
        }
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                for (int i = 0; i < dataGridView1.Rows.Count; i++)
                {
                    ...
                    {
                        cmd.Parameters.AddWithValue("@placements", 0);
                    }
                    else
                    {
                        cmd.Parameters.AddWithValue("@placements", Convert.ToInt32(dataGridView1.Rows[i].Cells[8].Value.ToString()));
                    }
                    if (dataGridView1.Rows[i].Cells[9].Value == DBNull.Value)
                    {
                        cmd.Parameters.AddWithValue("@videos", 0);
                    }
                    else
                    {
                        cmd.Parameters.AddWithValue("@videos", Convert.ToInt32(dataGridView1.Rows[i].Cells[9].Value.ToString()));
                    }
                    ...
                    {
                        cmd.Parameters.AddWithValue("@hours", Convert.ToDecimal(dataGridView1.Rows[i].Cells[10].Value.ToString()));
                    }
                    if (dataGridView1.Rows[i].Cells[11].Value == DBNull.Value)
                    {
                        cmd.Parameters.AddWithValue("@return_visits", 0);
                    }
                    else
                    {
                        cmd.Parameters.AddWithValue("@return_visits", Convert.ToInt32(dataGridView1.Rows[i].Cells[11].Value.ToString()));
                    }
                    ...
                    {
                        cmd.Parameters.AddWithValue("@bible_studies", Convert.ToInt32(dataGridView1.Rows[i].Cells[12].Value.ToString()));
                    }
                    if (dataGridView1.Rows[i].Cells[13].Value == DBNull.Value)
                    {
                        cmd.Parameters.AddWithValue("@remarks", "");
                    }
                    else
                    {
                        cmd.Parameters.AddWithValue("@remarks", dataGridView1.Rows[i].Cells[13].Value.ToString());
                    }
